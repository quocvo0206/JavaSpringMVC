<%@page import="com.itquocvv.constant.MessageEnum"%>
                    ...
                    <table class="table table-striped table-hover table-bordered" style="border: 1px solid #dee2e6;">
                      <thead>
                        <tr>
                          ...
                          <th style="width:10%;">Count Buy</th>
                          ...
                          <c:when test="${not empty listProducts}">
                            <c:forEach items="${listProducts}" var="itemProduct">
                              ...
                              <tr class="${rowClass}">
                                ...
                                <td class="cell-detail"><span>${itemProduct.countBuy}</span></td>
                                <td class="text-right">
                                  <a href="${pageContext.request.contextPath}/admin/product/edit/${itemUser.id}-${page}"><button class="btn btn-space btn-success"><i class="icon icon-left mdi mdi-edit"></i>Edit</button></a>
                                  <a href="${pageContext.request.contextPath}/admin/product/delete/${itemUser.id}" onclick="return confirm('Bạn có muốn xóa ${itemUser.username}')"><button class="btn btn-space btn-danger"><i class="icon icon-left mdi mdi-delete"></i>Delete</button></a>
                                </td>
                              </tr>
                            </c:forEach>
                          </c:when>
		    ...
		    <div class="col-sm-12 d-sm-flex justify-content-sm-center">
                ...
                <c:if test="${not empty paginations}">
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                      <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/product/search-${searchString}-${page - 1}" aria-label="Previous"><span class="mdi mdi-chevron-left" aria-hidden="true"></span></a></li>
                    </c:otherwise>
                  </c:choose>
                  ...
                  <c:forEach items="${paginations }" var="itemPagination">
                    <c:choose>
                      <c:when test="${itemPagination == page }">
                        <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath}/admin/product/search-${searchString}-${itemPagination}">${itemPagination}</a></li>
                      </c:when>
                      ...
                      <c:otherwise>
                        <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/product/search-${searchString}-${itemPagination}">${itemPagination}</a></li>
                      </c:otherwise>
                    </c:choose>
                  </c:forEach>
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                      <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/admin/product/search-${searchString}-${page + 1}" aria-label="Next"><span class="mdi mdi-chevron-right" aria-hidden="true"></span></a></li>
                    </c:otherwise>
                  </c:choose>
