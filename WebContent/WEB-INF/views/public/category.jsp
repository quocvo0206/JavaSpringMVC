    ...
    <div style="clear: both; ">
      ...
      <c:if test="${not empty paginations}">
        ...
        <c:choose>
          ...
          <c:otherwise>
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/${SlugUtil.makeSlug(itemProduct.name)}/page-${page - 1}.html" rel="next" aria-label="Next &amp;raquo;">‹</a></li>
          </c:otherwise>
        </c:choose>
        ...
        <c:forEach items="${paginations }" var="itemPagination">
          <c:choose>
            ...
            <c:otherwise>
              <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/${SlugUtil.makeSlug(itemProduct.name)}/page-${itemPagination}.html">${itemPagination}</a></li>
            </c:otherwise>
          </c:choose>
        </c:forEach>
